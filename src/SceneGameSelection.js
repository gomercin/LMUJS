...
var GameSelectionLayer = cc.Node.extend({
    ...
    createMenu : function() {
        ...
        this.mItemGameSize.setPosition(new cc.p(this.winsize.width/2,this.winsize.height/2 + 0*labelOffset));
        this.mItemGameSize.setFontSize(30);

        this.mItemGame3x3 = new cc.MenuItemFont("3x3", function(){this.onGameSizeTouch(3);}, this);
        this.mItemGame3x3.setPosition(new cc.p(this.winsize.width/2 - labelOffset,this.winsize.height/2 - 1*labelOffset));
        this.mItemGame4x4 = new cc.MenuItemFont("4x4", function(){this.onGameSizeTouch(4);}, this);
        this.mItemGame4x4.setPosition(new cc.p(this.winsize.width/2 + labelOffset,this.winsize.height/2 - 1*labelOffset));

        this.mItemGame5x5 = new cc.MenuItemFont("5x5", function(){this.onGameSizeTouch(5);}, this);
        this.mItemGame5x5.setPosition(new cc.p(this.winsize.width/2 - labelOffset,this.winsize.height/2 - 2*labelOffset));

        this.mItemGame6x6 = new cc.MenuItemFont("6x6", function(){this.onGameSizeTouch(6);}, this);
        this.mItemGame6x6.setPosition(new cc.p(this.winsize.width/2 + labelOffset,this.winsize.height/2 - 2*labelOffset));

        this.mItemGame7x7 = new cc.MenuItemFont("7x7", function(){this.onGameSizeTouch(7);}, this);
        this.mItemGame7x7.setPosition(new cc.p(this.winsize.width/2 - labelOffset,this.winsize.height/2 - 3*labelOffset));
        this.mItemGame8x8 = new cc.MenuItemFont("8x8", function(){this.onGameSizeTouch(8);}, this);
        this.mItemGame8x8.setPosition(new cc.p(this.winsize.width/2 + labelOffset,this.winsize.height/2 - 3*labelOffset));

        this.mItemStartGame = new cc.MenuItemFont("START", this.onTouch, this);
        this.mItemStartGame.setPosition(new cc.p(this.winsize.width/2,this.winsize.height/2 - 4*labelOffset));
